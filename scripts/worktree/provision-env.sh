...
if [ -n "$EXISTING_PROJECT" ] && \
  ...
  # principal.
  COMPUTED_KEYS="WEB_PORT PORT API_HOST AUTH_PORT AUTH_HOST METRO_PORT POSTGRES_HOST_PORT AUTH_POSTGRES_DB DATABASE_URL AUTH_DATABASE_URL AUTH_DATABASE_MIGRATION_URL AUTH_TEST_DATABASE_URL BACKEND_URL AUTH_ISSUER AUTH_PUBLIC_URL AUTH_WEB_APP_URL MOBILE_API_URL COMPOSE_PROJECT_NAME"
