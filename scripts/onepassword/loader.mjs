...
const SCOPES = Object.freeze({
  "api-runtime": {
    ...
    optional: ["OPENROUTER_API_KEY", "OPENROUTER_MODEL", "OPENROUTER_AGENT_MODEL", "AUDIO_TRANSCRIPTION_ENABLED", "AUDIO_TRANSCRIPTION_URL", "AUDIO_TRANSCRIPTION_KEY"],
  },
  "auth-runtime": {
    required: [
      "NODE_ENV",
