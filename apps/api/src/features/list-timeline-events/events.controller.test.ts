...
import { encodeTimelineCursor } from "../../infrastructure/persistence";
import {
  Event,
  EventItem,
  EventOwnershipError,
...
import { InMemoryDailyOverviewQuery } from "../../api-core/events/testing/in-memory-daily-overview.query";
import { InMemoryTimelineEventQuery } from "../../api-core/events/testing/in-memory-timeline-event.query";
...
import { DeleteEventUseCase } from "../delete-event/delete-event.usecase";
import { GetDailyOverviewUseCase } from "../get-daily-overview/get-daily-overview.usecase";
import { GetEventUseCase } from "../get-event/get-event.usecase";
import { ListTimelineEventsUseCase } from "./list-timeline-events.usecase";
import { UpdateEventUseCase } from "../update-event/update-event.usecase";
import { EventsController } from "./test-events-controller";
 ...
 * `GatewayIdentityGuard`, entao aqui o ator ja chega resolvido, como o decorator
