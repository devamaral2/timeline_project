...
export class PostgresAuthenticationRepository implements AuthenticationRepository {
  ...
  async completeLogin(command: CompleteLoginCommand, sign: import("../crypto/jwt").SignAccessToken): Promise<SessionCommit | "invalid"> {
