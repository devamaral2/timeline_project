...
import { lockActiveSigningKey } from "../authenticate-user/postgres-signing-key.repository";
import { buildUnsignedAccessTokenClaims, type SignAccessToken } from "../authenticate-user/jwt";
...
import type { AuthenticationMethod } from "../../domain/users/user";
