...
import type { AuthenticationRepository, CompleteLoginCommand, SessionCommit } from "./ports/authentication-repository";
import { buildUnsignedAccessTokenClaims } from "../authenticate-user/jwt";
import { resolveAccessInTransaction } from "../authorize-access/rbac/postgres-access";
...
export class PostgresAuthenticationRepository implements AuthenticationRepository {
  ...
  async completeLogin(command: CompleteLoginCommand, sign: import("../authenticate-user/jwt").SignAccessToken): Promise<SessionCommit | "invalid"> {
