...
import type { AuthenticationMethod, SigningKeyForSigning } from '../../domain/users/user';
import { isPermission, type Permission } from '../../domain/rbac/permissions';
import { decodeBase64Url, encodeBase64Url } from './base64url';
import type { PublicSigningJwk } from '../../domain/crypto/jwk';
import { publicKeyFromJwk } from '../../domain/crypto/signing-key';
...
export function buildUnsignedAccessTokenClaims(
  ...
  return { ...claims, iat, exp: iat + SECURITY_POLICY.accessTokenTtlSeconds };
}
